...
class LBFGSNEWA(Optimizer):
    ...
    def __init__(self, params, lr=1, max_iter=20, max_eval=None,
        ...
        super(LBFGSNEWA, self).__init__(params, defaults)
    ...
    def step(self, closure):
        ...
        # if state['n_iter'] != 0:
        #     print('Step is Entry', state['n_iter'])
        ...
        while n_iter < max_iter:
            ...
            if state['n_iter'] == 1:
                ...
                #print('Step is Old ', state['n_iter'])
                ...
                if ys > 1e-10:
                    ...
                    if y.dot(s) < 0.25*temp_value:
                        theta = (0.75*temp_value)/(temp_value - ys)
                    else:
                        theta = 1
                    #print('theta value is ', theta)

                    # Pranjal: code for calculating value of y_bar using value of theta
                    temp_y = torch.mul(H_diag_inverse, s)
                    #print('Abs of temp_y is ', temp_y.abs().sum())
                    y_bar = theta*y + (1-theta)*(temp_y)
            ...
            if state['n_iter'] == 1:
                ...
                t = 1/np.sqrt(state['n_iter']/5.0+1)
